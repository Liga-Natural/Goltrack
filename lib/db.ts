...
const CAMEL_CASE_COLUMNS: Record<string, string> = {
  ...
  fairplayalertthreshold: "fairPlayAlertThreshold",
  fairplaypublic: "fairPlayPublic",
  fairplayredpoints: "fairPlayRedPoints",
  fairplayyellowpoints: "fairPlayYellowPoints",
  imagemimetype: "imageMimeType",
  logomimetype: "logoMimeType",
  matchcenterenabled: "matchCenterEnabled",
